...
function groupDirty(platform){const d=groupDrafts[platform];return !!d&&(Object.keys(d.selections).length>0||Object.keys(d.mentions_only).length>0||JSON.stringify(d.keywords)!==JSON.stringify(d.baseKeywords));}
